          ...
          <div style="padding:28px 40px;">
            <table style="width:100%;border-collapse:collapse;">
              <tr style="border-bottom:1px solid #f0f0f0;">
                <td style="padding:10px 0;color:#999;font-size:12px;text-transform:uppercase;letter-spacing:1px;">Comprovativo</td>
                <td style="padding:10px 0;color:#0c3b2a;font-weight:bold;text-align:right;">Nº ${numComp}</td>
              </tr>
              <tr style="border-bottom:1px solid #f0f0f0;">
                <td style="padding:10px 0;color:#999;font-size:12px;text-transform:uppercase;letter-spacing:1px;">Valor pago</td>
              ...
              <tr style="border-bottom:1px solid #f0f0f0;">
                <td style="padding:10px 0;color:#999;font-size:12px;text-transform:uppercase;letter-spacing:1px;">Evento</td>
                <td style="padding:10px 0;color:#333;text-align:right;">28 de Março de 2026</td>
              </tr>
              <tr>
                <td style="padding:10px 0;color:#999;font-size:12px;text-transform:uppercase;letter-spacing:1px;">Local</td>
